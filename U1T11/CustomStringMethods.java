...
// WRITE AND TEST THE METHODS BELOW
  ...
  public String funnyString(String str, int idx) {
    String hold = str.substring(idx,idx+1);
    String newString = hold + str + hold;
    return newString;
  }
  ...
  */
  public String halvesReversed(String myString) {
    ...
    String second = myString.substring(half);
    return second + first;
  }
  ...
  */
  public String pigLatin(String orig) {
    ...
    String second = orig.substring(1);
    return second + firstLetter + "ay";
  }
  ...
  */
  ...
  public String endUp(String myString, int numToCap){
    int upper = myString.length() - numToCap;
    if (upper < 0) {
        upper = 0;
    }
    String makeUpper = myString.substring(upper);
    return myString.substring(0, upper) + makeUpper.toUpperCase();
  }
  ...
  */
  public String yellOrWhisper(String myString) {
    String check = myString.substring(0, 1);
